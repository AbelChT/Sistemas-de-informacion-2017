...
public class LibroDAO {
    ...
    public static void insertarValoracion(ValoracionVO valoracion, Connection connection) {
        try {
            /* Create "preparedStatement". */
            ...
            String usuario= valoracion.getUsuario().getNombreDeUsuario();
            String isbn= valoracion.getLibro().getIsbn();
            ...
            preparedStatement.setString(1, usuario);
            preparedStatement.setString(2, isbn);
            preparedStatement.setString(3, Integer.toString(puntuacion));
