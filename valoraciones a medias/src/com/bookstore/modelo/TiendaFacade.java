...
/*
    public static void insertarValoracionLibroFachada(String username, String isbn, int valor) {
        Connection connection = null;
        try {
            connection = GestorDeConexionesBD.getConnection();
        } catch (SQLException e) {
        ...
        UsuarioVO user = new UsuarioVO(username,"","","",null,"","",null, "");
        LibroVO libro= new LibroVO(isbn,"","","",0,null,null,"","","","",null,"");
        ValoracionVO valoracion = new ValoracionVO(user,libro,valor);

        insertarValoracion(valoracion, connection);
    }
*/
